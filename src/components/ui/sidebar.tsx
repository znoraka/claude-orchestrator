...
// Inline media query hook (replaces ~/hooks/useMediaQuery)
...
// Inline localStorage helpers (replaces ~/hooks/useLocalStorage with effect/Schema)
function getLocalStorageItem(key: string): number | null {
